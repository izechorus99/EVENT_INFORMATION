...
public class Fragments_upcoming extends Fragment {
    View view;
    ...
    private void setViewAdapter(){
        ...
        rvUpcoming.setAdapter(customAdapter);
        VerticalSpacingItemDecorator verticalSpacingItemDecorator = new VerticalSpacingItemDecorator(10);
        new ItemTouchHelper(simpleCallback).attachToRecyclerView(rvUpcoming);
        rvUpcoming.addItemDecoration(verticalSpacingItemDecorator);
