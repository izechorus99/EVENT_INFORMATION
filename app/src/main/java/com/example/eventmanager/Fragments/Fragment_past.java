...
public class Fragment_past extends Fragment {
    ...
    private void setViewAdapter(){
        ...
        rvPast.setAdapter(customAdapter);
        VerticalSpacingItemDecorator verticalSpacingItemDecorator = new VerticalSpacingItemDecorator(10);
        new ItemTouchHelper(simpleCallback).attachToRecyclerView(rvPast);
        rvPast.addItemDecoration(verticalSpacingItemDecorator);
        rvPast.setLayoutManager(new LinearLayoutManager(view.getContext()));
    }
